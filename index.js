...
/* because the nested function is in the same scope as the variable internal which is inside myFunction */
...
const cuboidTwo = new CuboidMakerTwo({length: 10, width: 10, height: 10});
